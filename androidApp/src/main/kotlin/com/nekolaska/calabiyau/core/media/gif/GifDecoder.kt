...
interface GifDecoder {
    ...
    /**
     * An interface that can be used to provide reused [Bitmap]s to avoid GCs
     * from constantly allocating [Bitmap]s for every frame.
     */
    ...
    @get:Deprecated(
        """Use {@link #getNetscapeLoopCount()} instead.
     ...
     * A count of 0 ([GifHeader.Companion.NETSCAPE_LOOP_COUNT_FOREVER]) means repeat indefinitely.
     ...
     * else -1 ([GifHeader.Companion.NETSCAPE_LOOP_COUNT_DOES_NOT_EXIST]).
     */
     ...
     * <tr><td>[GifHeader.Companion.NETSCAPE_LOOP_COUNT_FOREVER]</td>
     * <td>[.TOTAL_ITERATION_COUNT_FOREVER]</td></tr>
     * <tr><td>[GifHeader.Companion.NETSCAPE_LOOP_COUNT_DOES_NOT_EXIST]</td>
     * <td>`1`</td></tr>
     * <tr><td>`n (n > 0)`</td>
     * <td>`n + 1`</td></tr>
    </table> * 
     ...
     * 
     * 
     * Valid options are [Bitmap.Config.ARGB_8888] and
     * [Bitmap.Config.RGB_565].
     * [Bitmap.Config.ARGB_8888] will produce higher quality frames, but will
     ...
     * [Bitmap.Config.RGB_565] and the GIF contains transparent pixels,
     * [Bitmap.Config.ARGB_8888] will be used anyway to support the
     * transparency.
     */
    ...
    companion object {
        ...
        const val STATUS_PARTIAL_DECODE: Int = 3

        /** The total iteration count which means repeat forever.  */
        const val TOTAL_ITERATION_COUNT_FOREVER: Int = 0
    }
}
