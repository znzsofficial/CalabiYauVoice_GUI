...
# Third-party Compose libraries reference APIs that changed across Compose versions.
# These paths are optional UI effects/context menu integrations; keep warnings scoped.
